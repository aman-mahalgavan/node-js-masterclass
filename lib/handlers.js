...
handlers._users = {
    post: (data, callback) => {
        ...
        console.log("Payload is here --> ", firstName, lastName, phone, password, tosAgreement, data.payload.phone, data.payload.phone.length);
            ...
            _data.read('users', phone, (err, userData) => {
                if (!err && userData) {
                    ...
                    if (hashedPassword == userData.hashedPassword) {
                        ...
                        // Store the token
                        _data.create('tokens', tokenId, (err) => {
                            if (!err) {
